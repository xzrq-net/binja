...
- Add optional wayvnc under the private state directory, with owned startup/cleanup and a Unix socket. Verify viewing/input; screenshot CLI work belongs to `zbqnx2`.
